// frontend/screens/WaiterClosing10Screen.js (Nova Tela)
...
export default function WaiterClosing10Screen({ navigation }) {
    ...
    useEffect(() => {
        ...
        const c10 = baseComissao10 * 0.10; // << ALTERAÇÃO AQUI
        setComissao10(c10);
    ...
    const handleFinalSave = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${API_URL}/api/closings/waiter10`, closingData); // << NOVO ENDPOINT
            ...
            <SafeAreaView style={styles.container}>
                <ScrollView keyboardShouldPersistTaps="handled">
                    ...
                    <View style={[styles.section, styles.resultsContainer]}>
                        <Text style={styles.resultLabel}>Comissão 10%: <Text style={styles.resultValue}>{comissao10.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</Text></Text>
