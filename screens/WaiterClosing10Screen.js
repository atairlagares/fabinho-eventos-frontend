// frontend/screens/WaiterClosing10Screen.js (Versão com Modal Atualizado)
...
export default function WaiterClosing10Screen({ navigation }) {
    ...
    useEffect(() => {
        ...
        const baseComissao10 = numCashless > 0 ? numValorTotal - numCashless : numValorTotal;
        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? "padding" : "height"} style={{flex: 1}}>
            <SafeAreaView style={styles.container}>
                <ScrollView keyboardShouldPersistTaps="handled">
                    <Text style={styles.title}>Fechamento Garçom 10%</Text>
                    ...
                    <View style={[styles.section, styles.resultsContainer]}>
                        <Text style={styles.resultLabel}>Venda Total (10%): <Text style={styles.resultValue}>{comissao10.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</Text></Text>
                    ...
                    <View style={styles.modalView}>
                        ...
                        {dataToConfirm && (
                            <>
                                ...
                                <Text style={styles.modalText}>Venda Total (10%): <Text style={styles.modalBold}>{dataToConfirm.comissao10.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}</Text></Text>
